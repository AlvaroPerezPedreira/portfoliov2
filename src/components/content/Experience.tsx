  ...
  return (
    <>
      ...
      <Box w="100%" display="flex" justifyContent="center">
        <Timeline.Root maxW="600px" variant="outline">
          <Timeline.Item>
            <Timeline.Content />
            <Timeline.Connector>
              <Timeline.Separator />
          ...
          <Timeline.Item>
            <Timeline.Content textAlign="right">
              <Timeline.Title w="100%" justifyContent="flex-end">
                INDITEX | MERLIN SOFTWARE S.L.
              </Timeline.Title>
              <Timeline.Description>Noviembre 2025</Timeline.Description>
              <Timeline.Description>Presencial</Timeline.Description>
            </Timeline.Content>
            <Timeline.Connector>
              <Timeline.Separator />
              <Timeline.Indicator />
            ...
            <Timeline.Content>
              <Timeline.Title>
                Soporte Comercial | Desarrollador Junior
              </Timeline.Title>
              {/* <Text textStyle="xs">
